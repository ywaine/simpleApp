...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(C0077R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C0077R.C0079drawable.design_bottom_navigation_item_background);
        this.defaultMargin = res.getDimensionPixelSize(C0077R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C0077R.C0080id.icon);
        TextView textView = (TextView) findViewById(C0077R.C0080id.smallLabel);
        this.smallLabel = textView;
        TextView textView2 = (TextView) findViewById(C0077R.C0080id.largeLabel);
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        infoCompat.setRoleDescription(getResources().getString(C0077R.string.item_view_role_description));
    }
