...
final class IndicatorViewController {
    ...
    public IndicatorViewController(TextInputLayout textInputView2) {
        ...
        this.captionTranslationYPx = (float) context2.getResources().getDimensionPixelSize(C0077R.dimen.design_textinput_caption_translate_y);
    }
    ...
    public void setErrorEnabled(boolean enabled) {
        if (this.errorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                appCompatTextView.setId(C0077R.C0080id.textinput_error);
    ...
    public void setHelperTextEnabled(boolean enabled) {
        if (this.helperTextEnabled != enabled) {
            ...
            if (enabled) {
                ...
                appCompatTextView.setId(C0077R.C0080id.textinput_helper_text);
                if (Build.VERSION.SDK_INT >= 17) {
