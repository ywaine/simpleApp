...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C0077R.attr.snackbarButtonStyle};
    private static final int[] SNACKBAR_CONTENT_STYLE_ATTRS = {C0077R.attr.snackbarButtonStyle, C0077R.attr.snackbarTextViewStyle};
    ...
    public static Snackbar make(View view, CharSequence text, int duration) {
        ...
        if (parent != null) {
            SnackbarContentLayout content = (SnackbarContentLayout) LayoutInflater.from(parent.getContext()).inflate(hasSnackbarContentStyleAttrs(parent.getContext()) ? C0077R.layout.mtrl_layout_snackbar_include : C0077R.layout.design_layout_snackbar_include, parent, false);
