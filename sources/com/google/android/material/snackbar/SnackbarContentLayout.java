...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, C0077R.styleable.SnackbarLayout);
        this.maxWidth = a.getDimensionPixelSize(C0077R.styleable.SnackbarLayout_android_maxWidth, -1);
        this.maxInlineActionWidth = a.getDimensionPixelSize(C0077R.styleable.SnackbarLayout_maxActionInlineWidth, -1);
        a.recycle();
    }
    ...
    public void onFinishInflate() {
        ...
        this.messageView = (TextView) findViewById(C0077R.C0080id.snackbar_text);
        this.actionView = (Button) findViewById(C0077R.C0080id.snackbar_action);
    }
    ...
    public void updateActionTextColorAlphaIfNeeded(float actionTextColorAlpha) {
        if (actionTextColorAlpha != 1.0f) {
            this.actionView.setTextColor(MaterialColors.layer(MaterialColors.getColor(this, C0077R.attr.colorSurface), this.actionView.getCurrentTextColor(), actionTextColorAlpha));
        }
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int multiLineVPadding = getResources().getDimensionPixelSize(C0077R.dimen.design_snackbar_padding_vertical_2lines);
        int singleLineVPadding = getResources().getDimensionPixelSize(C0077R.dimen.design_snackbar_padding_vertical);
