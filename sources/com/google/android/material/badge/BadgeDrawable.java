...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private static final int DEFAULT_STYLE = C0077R.style.Widget_MaterialComponents_Badge;
    private static final int DEFAULT_THEME_ATTR = C0077R.attr.badgeStyle;
    ...
    public static final class SavedState implements Parcelable {
        ...
        public SavedState(Context context) {
            this.badgeTextColor = new TextAppearance(context, C0077R.style.TextAppearance_MaterialComponents_Badge).textColor.getDefaultColor();
            this.contentDescriptionNumberless = context.getString(C0077R.string.mtrl_badge_numberless_content_description);
            this.contentDescriptionQuantityStrings = C0077R.plurals.mtrl_badge_content_description;
            this.contentDescriptionExceedsMaxBadgeNumberRes = C0077R.string.mtrl_exceed_max_badge_number_content_description;
        }
    ...
    private void loadDefaultStateFromAttributes(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0077R.styleable.Badge, defStyleAttr, defStyleRes, new int[0]);
        setMaxCharacterCount(a.getInt(C0077R.styleable.Badge_maxCharacterCount, 4));
        if (a.hasValue(C0077R.styleable.Badge_number)) {
            setNumber(a.getInt(C0077R.styleable.Badge_number, 0));
        }
        setBackgroundColor(readColorFromAttributes(context, a, C0077R.styleable.Badge_backgroundColor));
        if (a.hasValue(C0077R.styleable.Badge_badgeTextColor)) {
            setBadgeTextColor(readColorFromAttributes(context, a, C0077R.styleable.Badge_badgeTextColor));
        }
        setBadgeGravity(a.getInt(C0077R.styleable.Badge_badgeGravity, TOP_END));
        setHorizontalOffset(a.getDimensionPixelOffset(C0077R.styleable.Badge_horizontalOffset, 0));
        setVerticalOffset(a.getDimensionPixelOffset(C0077R.styleable.Badge_verticalOffset, 0));
        a.recycle();
    }
    ...
    private BadgeDrawable(Context context) {
        ...
        this.badgeRadius = (float) res.getDimensionPixelSize(C0077R.dimen.mtrl_badge_radius);
        this.badgeWidePadding = (float) res.getDimensionPixelSize(C0077R.dimen.mtrl_badge_long_text_horizontal_padding);
        this.badgeWithTextRadius = (float) res.getDimensionPixelSize(C0077R.dimen.mtrl_badge_with_text_radius);
        TextDrawableHelper textDrawableHelper2 = new TextDrawableHelper(this);
        this.textDrawableHelper = textDrawableHelper2;
        textDrawableHelper2.getTextPaint().setTextAlign(Paint.Align.CENTER);
        this.savedState = new SavedState(context);
        setTextAppearanceResource(C0077R.style.TextAppearance_MaterialComponents_Badge);
    }
    ...
    private void calculateCenterAndBounds(Context context, Rect anchorRect, View anchorView) {
        ...
        int inset = context.getResources().getDimensionPixelSize(hasNumber() ? C0077R.dimen.mtrl_badge_text_horizontal_edge_offset : C0077R.dimen.mtrl_badge_horizontal_edge_offset);
        switch (this.savedState.badgeGravity) {
    ...
    private String getBadgeText() {
        ...
        return context.getString(C0077R.string.mtrl_exceed_max_badge_number_suffix, new Object[]{Integer.valueOf(this.maxBadgeNumber), DEFAULT_EXCEED_MAX_BADGE_NUMBER_SUFFIX});
    }
