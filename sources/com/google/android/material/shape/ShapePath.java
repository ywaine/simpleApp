...
public class ShapePath {
    ...
    public void lineTo(float x, float y) {
        ...
        float unused = operation.f84x = x;
        float unused2 = operation.f85y = y;
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix transform, ShadowRenderer shadowRenderer, int shadowElevation, Canvas canvas) {
            RectF rect = new RectF(0.0f, 0.0f, (float) Math.hypot((double) (this.operation.f85y - this.startY), (double) (this.operation.f84x - this.startX)), 0.0f);
        ...
        public float getAngle() {
            return (float) Math.toDegrees(Math.atan((double) ((this.operation.f85y - this.startY) / (this.operation.f84x - this.startX))));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public void applyToPath(Matrix transform, Path path) {
            ...
            path.lineTo(this.f84x, this.f85y);
