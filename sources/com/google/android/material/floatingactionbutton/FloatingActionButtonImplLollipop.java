...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    public BorderDrawable createBorderDrawable(int borderWidth, ColorStateList backgroundTint) {
        ...
        borderDrawable.setGradientColors(ContextCompat.getColor(context, C0077R.C0078color.design_fab_stroke_top_outer_color), ContextCompat.getColor(context, C0077R.C0078color.design_fab_stroke_top_inner_color), ContextCompat.getColor(context, C0077R.C0078color.design_fab_stroke_end_inner_color), ContextCompat.getColor(context, C0077R.C0078color.design_fab_stroke_end_outer_color));
