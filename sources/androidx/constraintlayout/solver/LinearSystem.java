...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object anchor) {
        ...
        if (anchor instanceof ConstraintAnchor) {
            ...
            if (variable.f53id == -1 || variable.f53id > this.mVariablesID || this.mCache.mIndexedVariables[variable.f53id] == null) {
                if (variable.f53id != -1) {
                    variable.reset();
                }
    ...
    private final int optimize(Row goal, boolean b) {
        ...
        while (!done) {
            ...
            if (goal.getKey() != null) {
                this.mAlreadyTestedCandidates[goal.getKey().f53id] = true;
            }
            SolverVariable pivotCandidate = goal.getPivotCandidate(this, this.mAlreadyTestedCandidates);
            if (pivotCandidate != null) {
                if (this.mAlreadyTestedCandidates[pivotCandidate.f53id]) {
                    return tries;
                }
                this.mAlreadyTestedCandidates[pivotCandidate.f53id] = true;
            }
            if (pivotCandidate != null) {
