...
public class FontsContractCompat {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x0086, code lost:
        sBackgroundThread.postAndReply(r2, new androidx.core.provider.FontsContractCompat.C02083());
     */
    ...
    public static android.graphics.Typeface getFontSync(final android.content.Context r9, final androidx.core.provider.FontRequest r10, final androidx.core.content.res.ResourcesCompat.FontCallback r11, final android.os.Handler r12, boolean r13, int r14, final int r15) {
        ...
        L_0x0063:
            ...
            monitor-enter(r5)
            androidx.collection.SimpleArrayMap<java.lang.String, java.util.ArrayList<androidx.core.provider.SelfDestructiveThread$ReplyCallback<androidx.core.provider.FontsContractCompat$TypefaceResult>>> r6 = sPendingReplies     // Catch:{ all -> 0x0091 }
            java.lang.Object r7 = r6.get(r0)     // Catch:{ all -> 0x0091 }
            java.util.ArrayList r7 = (java.util.ArrayList) r7     // Catch:{ all -> 0x0091 }
