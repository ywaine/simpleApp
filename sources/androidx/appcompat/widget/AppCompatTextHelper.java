...
class AppCompatTextHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        if (a.hasValue(C0005R.styleable.AppCompatTextHelper_android_drawableLeft)) {
            this.mDrawableLeftTint = createTintInfo(context, drawableManager, a.getResourceId(C0005R.styleable.AppCompatTextHelper_android_drawableLeft, 0));
        }
        if (a.hasValue(C0005R.styleable.AppCompatTextHelper_android_drawableTop)) {
            this.mDrawableTopTint = createTintInfo(context, drawableManager, a.getResourceId(C0005R.styleable.AppCompatTextHelper_android_drawableTop, 0));
        }
        if (a.hasValue(C0005R.styleable.AppCompatTextHelper_android_drawableRight)) {
            this.mDrawableRightTint = createTintInfo(context, drawableManager, a.getResourceId(C0005R.styleable.AppCompatTextHelper_android_drawableRight, 0));
        }
        if (a.hasValue(C0005R.styleable.AppCompatTextHelper_android_drawableBottom)) {
            this.mDrawableBottomTint = createTintInfo(context, drawableManager, a.getResourceId(C0005R.styleable.AppCompatTextHelper_android_drawableBottom, 0));
        }
        if (Build.VERSION.SDK_INT >= 17) {
            if (a.hasValue(C0005R.styleable.AppCompatTextHelper_android_drawableStart)) {
                this.mDrawableStartTint = createTintInfo(context, drawableManager, a.getResourceId(C0005R.styleable.AppCompatTextHelper_android_drawableStart, 0));
            }
            if (a.hasValue(C0005R.styleable.AppCompatTextHelper_android_drawableEnd)) {
                this.mDrawableEndTint = createTintInfo(context, drawableManager, a.getResourceId(C0005R.styleable.AppCompatTextHelper_android_drawableEnd, 0));
            }
        }
        a.recycle();
        ...
        if (ap != -1) {
            ...
            if (a2.hasValue(C0005R.styleable.TextAppearance_textLocale)) {
                localeListString2 = a2.getString(C0005R.styleable.TextAppearance_textLocale);
            }
            if (Build.VERSION.SDK_INT >= 26 && a2.hasValue(C0005R.styleable.TextAppearance_fontVariationSettings)) {
                fontVariation = a2.getString(C0005R.styleable.TextAppearance_fontVariationSettings);
            }
            a2.recycle();
        }
    ...
    private void updateTypefaceAndStyle(Context context, TintTypedArray a) {
        ...
        if (a.hasValue(C0005R.styleable.TextAppearance_android_fontFamily) || a.hasValue(C0005R.styleable.TextAppearance_fontFamily)) {
            ...
            int fontFamilyId = a.hasValue(C0005R.styleable.TextAppearance_fontFamily) ? C0005R.styleable.TextAppearance_fontFamily : C0005R.styleable.TextAppearance_android_fontFamily;
