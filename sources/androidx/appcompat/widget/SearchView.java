...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        C01615 r1 = new View.OnClickListener() {
        ...
        C01637 r2 = new TextView.OnEditorActionListener() {
    ...
    public void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0005R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0005R.dimen.abc_dropdownitem_text_padding_left) : 0;
