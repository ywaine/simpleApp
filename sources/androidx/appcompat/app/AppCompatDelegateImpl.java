...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private AppCompatDelegateImpl(android.content.Context r4, android.view.Window r5, androidx.appcompat.app.AppCompatCallback r6, java.lang.Object r7) {
        ...
        L_0x0032:
            ...
            java.util.Map<java.lang.Class<?>, java.lang.Integer> r0 = sLocalNightModes
        ...
        if (!panelFeatureState.isOpen && !this.mIsDestroyed) {
            ...
            if (cb == null || cb.onMenuOpened(panelFeatureState.featureId, panelFeatureState.menu)) {
                ...
                if (wm != null && preparePanel(st, event)) {
                    ...
                    WindowManager.LayoutParams layoutParams = new WindowManager.LayoutParams(width, -2, panelFeatureState.f46x, panelFeatureState.f47y, PointerIconCompat.TYPE_HAND, 8519680, -3);
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (mlp.topMargin != (localInsets.top == 0 ? insetTop : 0)) {
                    ...
                    if (view == null) {
                        ...
                        view2.setBackgroundColor(this.mContext.getResources().getColor(C0005R.C0006color.abc_input_method_navigation_guard));
