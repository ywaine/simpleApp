...
class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final Pair<Integer, String> findAnyOf$StringsKt__StringsKt(CharSequence $this$findAnyOf, Collection<String> strings, int startIndex, boolean ignoreCase, boolean last) {
                ...
                if ((step > 0 && index <= last2) || (step < 0 && last2 <= index)) {
                    ...
                    while (true) {
                        ...
                        if (matchingString == null) {
                            ...
                            return TuplesKt.m22to(Integer.valueOf(index2), matchingString);
                        }
                    }
                }
            } else {
                ...
                if ((step2 > 0 && index3 <= last3) || (step2 < 0 && last3 <= index3)) {
                    ...
                    while (true) {
                        ...
                        if (matchingString2 == null) {
                            ...
                            return TuplesKt.m22to(Integer.valueOf(index4), matchingString2);
                        }
                    }
                }
            }
        ...
        return TuplesKt.m22to(Integer.valueOf(index5), string);
    }
