...
public final class ResultKt {
    ...
    private static final <R> Object runCatching(Function0<? extends R> block) {
        ...
        try {
            ...
            return Result.m49constructorimpl(block.invoke());
        } catch (Throwable e) {
            Result.Companion companion2 = Result.Companion;
            return Result.m49constructorimpl(createFailure(e));
        }
    }
    ...
    private static final <T, R> Object runCatching(T $this$runCatching, Function1<? super T, ? extends R> block) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            return Result.m49constructorimpl(block.invoke($this$runCatching));
        } catch (Throwable e) {
            Result.Companion companion2 = Result.Companion;
            return Result.m49constructorimpl(createFailure(e));
        }
    ...
    private static final <R, T extends R> R getOrElse(Object $this$getOrElse, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        Throwable exception = Result.m52exceptionOrNullimpl($this$getOrElse);
        if (exception == null) {
    ...
    private static final <R, T extends R> R getOrDefault(Object $this$getOrDefault, R defaultValue) {
        if (Result.m55isFailureimpl($this$getOrDefault)) {
            return defaultValue;
        }
    ...
    private static final <R, T> R fold(Object $this$fold, Function1<? super T, ? extends R> onSuccess, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        Intrinsics.checkNotNullParameter(onFailure, "onFailure");
        Throwable exception = Result.m52exceptionOrNullimpl($this$fold);
        if (exception == null) {
    ...
    private static final <R, T> Object map(Object $this$map, Function1<? super T, ? extends R> transform) {
        ...
        if (!Result.m56isSuccessimpl($this$map)) {
            return Result.m49constructorimpl($this$map);
        }
        Result.Companion companion = Result.Companion;
        return Result.m49constructorimpl(transform.invoke($this$map));
    }

    private static final <R, T> Object mapCatching(Object $this$mapCatching, Function1<? super T, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        if (!Result.m56isSuccessimpl($this$mapCatching)) {
            return Result.m49constructorimpl($this$mapCatching);
        }
        try {
            Result.Companion companion = Result.Companion;
            return Result.m49constructorimpl(transform.invoke($this$mapCatching));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            return Result.m49constructorimpl(createFailure(th));
        }
    }

    private static final <R, T extends R> Object recover(Object $this$recover, Function1<? super Throwable, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        Throwable exception = Result.m52exceptionOrNullimpl($this$recover);
        if (exception == null) {
            return $this$recover;
        }
        Result.Companion companion = Result.Companion;
        return Result.m49constructorimpl(transform.invoke(exception));
    }
    ...
    private static final <R, T extends R> Object recoverCatching(Object $this$recoverCatching, Function1<? super Throwable, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        Throwable exception = Result.m52exceptionOrNullimpl($this$recoverCatching);
        if (exception == null) {
    ...
    private static final <T> Object onFailure(Object $this$onFailure, Function1<? super Throwable, Unit> action) {
        ...
        Throwable it = Result.m52exceptionOrNullimpl($this$onFailure);
        if (it != null) {
            action.invoke(it);
        }
    ...
    private static final <T> Object onSuccess(Object $this$onSuccess, Function1<? super T, Unit> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        if (Result.m56isSuccessimpl($this$onSuccess)) {
