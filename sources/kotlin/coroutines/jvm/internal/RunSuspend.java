...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m1256getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object result2) {
        synchronized (this) {
            this.result = Result.m48boximpl(result2);
        ...
        synchronized (this) {
            while (true) {
                ...
                if (result2 == null) {
                    ...
                    ResultKt.throwOnFailure(result2.m58unboximpl());
                }
            }
        }
    }
