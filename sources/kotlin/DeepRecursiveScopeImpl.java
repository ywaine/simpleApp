...
final class DeepRecursiveScopeImpl<T, R> extends DeepRecursiveScope<T, R> implements Continuation<R> {
    ...
    private final Continuation<Object> crossFunctionCompletion(Function3<? super DeepRecursiveScope<?, ?>, Object, ? super Continuation<Object>, ? extends Object> currentFunction, Continuation<Object> cont2) {
        return new C0632x3ce6e4bb(EmptyCoroutineContext.INSTANCE, this, currentFunction, cont2);
    }
    ...
    public final R runCallLoop() {
        while (true) {
            ...
            if (cont2 == null) {
                ...
                return result2;
            } else if (Result.m51equalsimpl0(DeepRecursiveKt.UNDEFINED_RESULT, result2)) {
                try {
                    ...
                    if (r != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                        ...
                        cont2.resumeWith(Result.m49constructorimpl(r));
                    }
                } catch (Throwable e) {
                    Result.Companion companion2 = Result.Companion;
                    cont2.resumeWith(Result.m49constructorimpl(ResultKt.createFailure(e)));
                }
            } else {
